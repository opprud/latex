...
%    \node [sum, right of=input] (sum) {};
    \node [block] (knowledge) {Knowledge};
    \node [block] (persuation, right of = knowledge) {persuation};
%    \node [block] (decision, right of = persuation) {decision};
%    \node [block] (implementation, right of = decision) {implementation};
%    \node [block] (confirmation, right of = implementation) {confirmation};
...
%    \draw [->] (knowledge) -- node (persuation);
    \draw [draw,->] (knowledge) -- node {$r$} (sum);
