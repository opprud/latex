...
Attempting to enforce new technology aided habits in a population can be described by models of techhnology adoption. 
Traditional approaches suggest that technology adopters gain interest in a product by acquiring it and assing its application, hereby collecting knowledge about it. \cite{gilbert}

Adoption of innovations, where innovations are defined as an idea, practice or object suited for adoption, is well described Everett Rogers diffusion research.
...
\textbf{FIGURE}Rates of adoption

The figure shows successive groups of consumers each adopting technology at different rates.
...
\begin{tabular}{|p{1.2cm} |p{5.5cm}|} % centered columns (4 columns)
...
Early majority &  
This group, representing 34 \% of consumers \bibitem{adoption2} are the careful consumers, avoiding the big risks, by relying on feedback from the early adopter group. 
This group seldom represents the opinion makers, but rely on feedback and recommendations from others.
 \\

Late majority & 35 \\

Laggards & 45 \\ [1ex]      % [1ex] adds vertical space
...
\bibitem{diffusion2} \emph{product diffusion curve},\relax www.quickmba.com/markting/product/diffusion
\end{thebibliography}
