...
\textit{Interest}, is the ultimate dependent variable, leading to the adoption decision, interest is similar to Rogers \textit{Persuation}. Interest described the likelihood of adoption. \newline
...
Photovoltaics has gained massive interest in Denmark and Germany, in particular, so a model assesing the rapid growth, within this field is believed also to be suited, when looking into changing energy habits into something a bit more green, aided by IT.
...
The fourth column in table ~\ref{table:asses_init} attempt to rate the campaigns aim, at each of Kaplans factors, stimulatig adoption.
...
Educational, Reveal "hidden" consumption, Reward initiative, Promote energy-leadership & Early majority\newline  Late Majority &
Motivation  [high] \newline 
Context	    [high] \newline 
Knowledge	[high] \newline 
Experience  [low] \newline 
